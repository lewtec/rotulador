...
func (q *Queries) CheckAnnotationExists(ctx context.Context, arg CheckAnnotationExistsParams) (bool, error) {
...
func (q *Queries) CheckAnnotationExistsForImageStage(ctx context.Context, arg CheckAnnotationExistsForImageStageParams) (bool, error) {
...
func (q *Queries) GetImagesWithoutAnnotationForStage(ctx context.Context, stageIndex int64) ([]GetImagesWithoutAnnotationForStageRow, error) {
	rows, err := q.db.QueryContext(ctx, getImagesWithoutAnnotationForStage, stageIndex)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
